...
namespace DuloGamesEditor.UI {
    ...
    public class UISlotBaseEditor : Editor {
        ...
        private SerializedProperty m_BorderGraphicProperty;
        ...
        protected virtual void OnEnable() {
            ...
            this.m_BorderGraphicProperty = this.serializedObject.FindProperty("borderGraphic");
        ...
        protected void DrawGraphicProperties() {
            EditorGUILayout.LabelField("Graphic Properties", EditorStyles.boldLabel);
            ...
            EditorGUILayout.PropertyField(this.m_BorderGraphicProperty, new GUIContent("Border Graphic"));

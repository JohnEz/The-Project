...
using DuloGames.UI;
using UnityEditor;
using DuloGamesEditor.UI;

[CanEditMultipleObjects, CustomEditor(typeof(EquipmentSlot), true)]
public class UIEquipSlotEditor : UISlotBaseEditor {
    ...
    protected override void OnEnable() {
        base.OnEnable();
        this.m_EquipTypeProperty = this.serializedObject.FindProperty("equipSlotType");
